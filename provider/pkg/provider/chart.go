...
// SidecarInjector provisions a NGINX reverse proxy and load balancer for Kubernetes.
type SidecarInjector struct {
	pulumi.ResourceState
	Status helmv3.ReleaseStatusOutput `pulumi:"status" pschema:"out"`
}

func (c *SidecarInjector) SetOutputs(out helmv3.ReleaseStatusOutput) { c.Status = out }
func (c *SidecarInjector) Type() string                              { return ComponentName }
func (c *SidecarInjector) DefaultChartName() string                  { return "ingress-nginx" }
func (c *SidecarInjector) DefaultRepoURL() string {
	return "https://kubernetes.github.io/ingress-nginx"
}

// SidecarInjectorArgs contains the set of arguments for creating a SidecarInjector component resource.
...
func (args *SidecarInjectorArgs) R() **helmbase.ReleaseType { return &args.HelmOptions }
