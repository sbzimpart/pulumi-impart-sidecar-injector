module github.com/impart-security/pulumi-impart-sidecar-injector
...
require (
	...
	github.com/pulumi/pulumi-go-helmbase v0.0.14 // indirect
	github.com/pulumi/pulumi-kubernetes/sdk/v3 v3.18.3 // indirect
